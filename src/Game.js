...
export class CreateGame {
  ...
  gameSetup () {
    ...
    for (let i = 0; i <= numOfPlayers - 1; i++) { // skapar spelarna och summerar (ej dealer)
      ...
      // sums cards
      this.sumCards(i) // DENNA FUNGERAR INTE! summan visas inte!
      /*
  ...
  dealerPlayerNewCard (playerId, maxtotVal) {
    ...
    // kontrollerar ess värde innan loopen startar
...
*/
    // dealerns hand flyttas till slänghögen (flyttad till slutet av GAMEROUND!)
